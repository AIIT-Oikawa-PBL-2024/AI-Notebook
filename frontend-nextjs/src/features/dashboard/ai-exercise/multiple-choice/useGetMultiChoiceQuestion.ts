...
const STORAGE_KEY = "cached_multi_choice_question";
const GENERATION_STATUS_KEY = "multi_choice_generation_status";

export function useGetMultiChoiceQuestion(id?: string) {
	...
	const generateExercise = useCallback(async () => {
		...
		try {
			...
			const endpoint = id
				...
				: `${process.env.NEXT_PUBLIC_BACKEND_HOST}/exercises/multiple_choice`;
			...
			if (!response.ok) {
				throw new Error("選択問題の取得に失敗しました");
			}
