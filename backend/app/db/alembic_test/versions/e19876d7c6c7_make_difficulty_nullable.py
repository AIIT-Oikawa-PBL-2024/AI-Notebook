...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "username", mysql.VARCHAR(collation="utf8mb4_unicode_ci", length=256), nullable=False
        ),
        sa.Column(
            "email", mysql.VARCHAR(collation="utf8mb4_unicode_ci", length=256), nullable=False
        ),
        sa.Column(
            "password", mysql.VARCHAR(collation="utf8mb4_unicode_ci", length=256), nullable=False
        ),
        sa.PrimaryKeyConstraint("id"),
