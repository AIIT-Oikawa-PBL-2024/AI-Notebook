...
def show_sidebar() -> None:
    with st.sidebar:
        ...
        st.page_link("pages/study_ai_note.py", label="AI出力", icon="🤖")
        st.page_link("pages/study_ai_exercise.py", label="AI練習問題", icon="📝")
        st.page_link("pages/notebook.py", label="ノート", icon="🗒️")
